...
mv ../bin/gurux.dlms.server.bin ../bin/gurux.dlms.advanced.server.single.phase.bin
...
mv ../bin/gurux.dlms.server.bin ../bin/gurux.dlms.advanced.server.three.phase.bin
